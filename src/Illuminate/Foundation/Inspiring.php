...
class Inspiring
{
    ...
    {
        return static::formatForConsole(static::randomQuote());
    }
     ...
     *
     * @param  array{text: string, author: string}  $quote
     * @return string
     */
    protected static function formatForConsole($quote)
    {
        return sprintf(self::CONSOLE_FORMAT, $quote['text'], $quote['author']);
    }
}
